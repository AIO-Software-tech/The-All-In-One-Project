	            ...
	            time.sleep(1)
		                ...
		                # Calculator: Converter
		                    ...
		                    if unit == 1:
		                        ...
		                        print(str(km) + " Km is " + str(km * 0.621) + " Miles")
		                        time.sleep(1)
									
									#Miles to Km
		                    elif unit == 2:
		                        miles = int(input("How Many Miles Do You Want To Convert? "))
		                        print(str(miles) + " Miles is " + str(miles * 1.609) + " Km")
		                        time.sleep(1)
		                        ...
		                        print(str(pounds) + " Lb is " + str(pounds * 2.2) + " Kg")
		                        time.sleep(1)
		
									#Cm to Inches
		                    elif unit == 5:
		                        cm = int(input("How Many Cm Do You Want To Convert ? "))
		                        print(str(cm) + " Cm is " + str(cm / 2.54) + " Inches")
		                        time.sleep(1)
		
									#Inches to cm
		                    elif unit == 6:
		                        inch = int(input("How Many Inches Do You Want To Convert ? "))
		                        print(str(inch) + " Inches is " + str(inch * 2.54) + " Cm")
		                        time.sleep(1)
