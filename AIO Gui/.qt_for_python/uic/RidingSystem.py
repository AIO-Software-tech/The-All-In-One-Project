...
# Form implementation generated from reading ui file 'c:\Users\ogban\Desktop\The-All-In-One-Project\The-All-In-One-Project\AIO Gui\RidingSystem.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Input_1.setGeometry(QtCore.QRect(210, 150, 231, 41))
        font = QtGui.QFont()
        ...
        self.Submit.setGeometry(QtCore.QRect(120, 320, 251, 81))
        font = QtGui.QFont()
...
"background-color: rgb(42, 74, 89);")
        ...
        self.Input_2 = QtWidgets.QCheckBox(Dialog)
        self.Input_2.setGeometry(QtCore.QRect(170, 220, 161, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Input_2.setFont(font)
        self.Input_2.setStyleSheet("color: rgb(230, 200, 85);")
        self.Input_2.setObjectName("Input_2")
        self.output = QtWidgets.QLineEdit(Dialog)
        self.output.setGeometry(QtCore.QRect(420, 450, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setStrikeOut(False)
        font.setKerning(True)
        ...
        self.label_4.setGeometry(QtCore.QRect(240, 450, 171, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Height</p></body></html>"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Riding System</p></body></html>"))
        self.Submit.setText(_translate("Dialog", "Submit"))
        self.Input_2.setText(_translate("Dialog", "Are You Over 18"))
        self.output.setText(_translate("Dialog", "0"))
        self.label_4.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Num Of People On The Ride</p></body></html>"))
