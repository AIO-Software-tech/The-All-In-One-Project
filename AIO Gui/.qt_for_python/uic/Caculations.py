...
"background-color: rgb(42, 74, 89);")
        ...
        self.RectangleArea = QtWidgets.QPushButton(Dialog)
        self.RectangleArea.setGeometry(QtCore.QRect(120, 230, 271, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.RectangleArea.setFont(font)
        self.RectangleArea.setStyleSheet("color: rgb(230, 200, 85);\n"
"background-color: rgb(42, 74, 89);")
        self.RectangleArea.setObjectName("RectangleArea")
...
"background-color: rgb(42, 74, 89);")
        ...
        self.RidingSystem = QtWidgets.QPushButton(Dialog)
        self.RidingSystem.setGeometry(QtCore.QRect(120, 350, 271, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.RidingSystem.setFont(font)
        self.RidingSystem.setStyleSheet("color: rgb(230, 200, 85);\n"
"background-color: rgb(42, 74, 89);")
        self.RidingSystem.setObjectName("RidingSystem")
...
"background-color: rgb(42, 74, 89);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.RectangleArea.setText(_translate("Dialog", "Rectangle Area"))
        self.VotingSystem.setText(_translate("Dialog", "Voting System"))
        self.RidingSystem.setText(_translate("Dialog", "Riding System"))
