...
# Form implementation generated from reading ui file 'c:\Users\ogban\Desktop\The-All-In-One-Project\The-All-In-One-Project\AIO Gui\Game Menu.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.NAC = QtWidgets.QPushButton(Dialog)
        self.NAC.setGeometry(QtCore.QRect(60, 100, 391, 81))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.NAC.setFont(font)
        self.NAC.setStyleSheet("color: rgb(230, 200, 85);\n"
"background-color: rgb(42, 74, 89);")
        self.NAC.setObjectName("NAC")
        self.Personal_2 = QtWidgets.QPushButton(Dialog)
        self.Personal_2.setGeometry(QtCore.QRect(110, 200, 291, 81))
        font = QtGui.QFont()
        font.setPointSize(30)
...
"background-color: rgb(42, 74, 89);")
        ...
        self.Personal_3.setGeometry(QtCore.QRect(110, 300, 291, 81))
        font = QtGui.QFont()
        font.setPointSize(30)
...
"background-color: rgb(42, 74, 89);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "AIO | Games Menu"))
        self.label.setText(_translate("Dialog", "Games Menu"))
        ...
        self.NAC.setText(_translate("Dialog", "Noughts And Crosses"))
        self.Personal_2.setText(_translate("Dialog", "Battel Ships"))
