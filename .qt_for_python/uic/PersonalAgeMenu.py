...
# Form implementation generated from reading ui file 'c:\Users\ogban\Desktop\The-All-In-One-Project\The-All-In-One-Project\AIO Gui\PersonalAgeMenu.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.BirthYear = QtWidgets.QLineEdit(Dialog)
        self.BirthYear.setGeometry(QtCore.QRect(210, 180, 261, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setStrikeOut(False)
        font.setKerning(True)
        self.BirthYear.setFont(font)
        self.BirthYear.setStyleSheet("color: rgb(230, 200, 85);")
        self.BirthYear.setText("")
        ...
        self.YourAge = QtWidgets.QLineEdit(Dialog)
        self.YourAge.setGeometry(QtCore.QRect(210, 120, 261, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setStrikeOut(False)
        font.setKerning(True)
        self.YourAge.setFont(font)
        self.YourAge.setStyleSheet("color: rgb(230, 200, 85);")
        self.YourAge.setText("")
        self.YourAge.setObjectName("YourAge")
...
"background-color: rgb(42, 74, 89);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Your age</p></body></html>"))
        self.label_4.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Birth Year</p></body></html>"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Age</p></body></html>"))
