...
"background-color: rgb(42, 74, 89);")
        ...
        self.Personal_4 = QtWidgets.QPushButton(Dialog)
        self.Personal_4.setGeometry(QtCore.QRect(120, 290, 271, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.Personal_4.setFont(font)
        self.Personal_4.setStyleSheet("color: rgb(230, 200, 85);\n"
"background-color: rgb(42, 74, 89);")
        self.Personal_4.setObjectName("Personal_4")
