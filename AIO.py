...
def UserPass():
    ...
    if username == "Ollie" or username == "Admin" or username == "Imre":
        ...
        elif username == "Imre" and password == "n@KoRi<ï¿½":
...
def Menu():
    ...
    while True:
        ...
        print("ï¿½   1. = Personal                               ï¿½")

        print("ï¿½                                               ï¿½")

        print("ï¿½   2. = Calculations                           ï¿½")
        ...
        # Calculations:
            ...
            print("ï¿½   1. = Standard         ï¿½")

            print("ï¿½                         ï¿½")

            print("ï¿½   2. = Converter        ï¿½")

            print("ï¿½                         ï¿½")

            print("ï¿½   3. = Rectangle Area   ï¿½")

            print("ï¿½                         ï¿½")

            print("ï¿½   4. = Voting System    ï¿½")

            print("ï¿½                         ï¿½")

            print("ï¿½   5. = Riding System    ï¿½")

            print("ï¿½                         ï¿½")

            print("ï¿½   6. = Battery Charge   ï¿½")
        ...
        # Games:
            ...
            print("ï¿½  1 = Battle Ships        ï¿½")

            print("ï¿½                          ï¿½")

            print("ï¿½  2 = Coin Flip           ï¿½")

            print("ï¿½                          ï¿½")

            print("ï¿½  3 = Connect Four        ï¿½")

            print("ï¿½                          ï¿½")

            print("ï¿½  4 = Noughts And Crosses ï¿½")
        ...
        # Error Codes:
            ...
            print("ï¿½   1. = Invalid option/chose    ï¿½")

            print("ï¿½                                ï¿½")

            print("ï¿½   2. = Invalid Username        ï¿½")

            print("ï¿½                                ï¿½")

            print("ï¿½   3. = Invalid Password        ï¿½")

            print("ï¿½                                ï¿½")

            print("ï¿½   4. = Invalid input           ï¿½")
